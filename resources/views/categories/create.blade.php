                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea 
                                ...
                                name="metadata" 
                                class="rounded-md border-gray-300 shadow-sm w-full"
                            >{{ old('metadata', '{"key": "value"}') }}</textarea>
                            @error('metadata')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex justify-end mt-6">
                            <a href="{{ route('categories.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 focus:outline-none focus:bg-gray-300 transition ease-in-out duration-150 mr-2">
                                {{ __('Cancel') }}
                            </a>
