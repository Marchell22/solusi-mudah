                    ...
                    <form action="{{ route('borrowings.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea 
                                ...
                                class="rounded-md border-gray-300 shadow-sm w-full"
                                rows="3"
                            >{{ old('notes', '{"purpose": "research", "condition": "good"}') }}</textarea>
                            @error('notes')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex justify-end mt-6">
                            <a href="{{ route('borrowings.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 focus:outline-none focus:bg-gray-300 transition ease-in-out duration-150 mr-2">
                                {{ __('Cancel') }}
                            </a>
